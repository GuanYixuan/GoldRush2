"""Symmetry observation probe for map 3, layout M3-A.

This layout is separate from layout A because map 3 has a different wall
structure and the old P2 anchors are walls on map 3.
"""
