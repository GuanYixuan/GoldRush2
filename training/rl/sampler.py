...
from simulator.mechanisms.maps import MapPool, SpawnConfig, built_in_training_map_pool
    ...
    def collect(
        ...
        *,
        ...
        for pair_index in range(pair_count):
            ...
            requested_map_key = _sample_training_map_key(self.map_pool, requested_map_id, episode_seed)
